...
def parse_declaration(declaration):
    ...
    if (len(declaration) >= 2) and (declaration[0] ==
                                    '(') and (declaration[-1] == ')'):
        # continue process
        ...
        for region in self.view.sel():
            ...
            if region.empty():
                ...
                if len(previous_contents.strip()) == 0:
                    # print "at the begin of the file"
                    # " so we can insert module docstring"
                ...
                if flag:
                    ...
                    try:
                        ...
                        # print "row = %s, col = %s" %
                        # (self.view.rowcol(declaration_region.end()))
                        self.view.insert(
                            edit,
